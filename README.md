...
This coroutines are organied in a circular queue (using a doubly linked list) and the "scheduling" is just round robin, so when a coroutine yields the current thread just looks at the next node of the list and do the context switch.\
